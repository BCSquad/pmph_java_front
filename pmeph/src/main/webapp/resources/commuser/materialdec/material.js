...
/*var validRules = [];
 validRules.push({id: "realname", rule: "isNonEmpty", message: "姓名不能为空"});
 validRules.push({id: "birthday", rule: "isNonEmpty", message: "出生日期不能为空"});
 validRules.push({id: "experience", rule: "isNonEmpty|onlyInt", message: "教龄不能为空|教龄必须是数字"});
 validRules.push({id: "org_name", rule: "isNonEmpty", message: "工作单位不能为空"});
 validRules.push({id: "position", rule: "isNonEmpty", message: "职务不能为空"});
 validRules.push({id: "zc", rule: "isNonEmpty", message: "职称不能为空"});
 validRules.push({id: "address", rule: "isNonEmpty", message: "地址不能为空"});
 validRules.push({id: "email", rule: "isNonEmpty|isEmail", message: "邮箱不能为空|邮箱格式不正确"});
 validRules.push({id: "handphone", rule: "isNonEmpty|isMobile", message: "手机号码不能为空|手机号码格式不正确"});
 validRules.push({id: "zjlx", rule: "isNonEmpty", message: "证件类型不能为空"});
 validRules.push({id: "idcard", rule: "isNonEmpty", message: "证件号码不能为空"});
 validRules.push({id: "sbdw_name", rule: "isNonEmpty", message: "申报单位不能为空"});*/
