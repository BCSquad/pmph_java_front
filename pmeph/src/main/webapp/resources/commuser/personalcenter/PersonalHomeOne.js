...
function listoction3(){
	window.location.href=contextpath+'personalhomepage/tohomepageone.action?bookname='+$("#wdsbssk").val()+"&&is_staging=1&&online_progress=1";
	
}
function listoction4(){
	window.location.href=contextpath+'personalhomepage/tohomepageone.action?bookname='+$("#wdsbssk").val()+"&&online_progress=1";
