...
function listoction1(){
	window.location.href=contextpath+'personalhomepage/tohomepageonelist.action?bookname='+$("#wdsbssk").val()+"&&dateinfo=1&&pageinfo=1";
	
}
function listoction2(){
	window.location.href=contextpath+'personalhomepage/tohomepageonelist.action?bookname='+$("#wdsbssk").val()+"&&dateinfo=2&&pageinfo=2";
	
}
function listoction3(){
	window.location.href=contextpath+'personalhomepage/tohomepageonelist.action?bookname='+$("#wdsbssk").val()+"&&is_staging=1&&online_progress=1&&pageinfo=3";
	
}
function listoction4(){
	window.location.href=contextpath+'personalhomepage/tohomepageonelist.action?bookname='+$("#wdsbssk").val()+"&&online_progress=1&&pageinfo=4";
