...
<div class="message-body">
    ...
    <div class="bookmistake" id="bookmistake">
        <form id="bookmistakeform">
            ...
            <div class="info">
                <label style="margin-left: 20px" class="labell">附件:<span id="tattachment"
                                                                         class="listContent"></span></label>
            </div>
            <div class="clear"></div>
        </form>
    </div>
    ...
    <div class="message-list">
        ...
        <div id="message-list">
            <c:forEach items="${list}" var="item">
                <div class="item" id="item${item.msg_id}">
                    ...
                    <div class="content" onclick="system('${item.id}','${item.NAME}','${item.TIME}')"
                         style="width:1000px">
                        <p class="title">
        ...
        <c:if test="${listSize>=8 }">
            <div class="load-more" id="load-more">
                <a href="javascript:void(0);" onclick="loadMore('send')"><p class="load-text">加载更多...</p></a>
            </div>
        </c:if>
