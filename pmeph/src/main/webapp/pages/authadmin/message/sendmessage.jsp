    ...
    <form class="message-list" id="theForm">
        ...
        <div class="message-input">
            ...
            <div style="height:auto !important;min-height:600px;height:600px;">
                <script type="text/plian" id="mText" style="width: 1060px; height:478px;scorll-y:true;position:absolute;margin-left:0px;left:126px;"></script>
        ...
        <div class="appendix">
            ...
            <div style="display: inline;">
                ...
                <span class="name" id="file_name"></span>
                <a href="javascript:void(0);" class="operate input">
                    <span id="up_txt">上传</span>
                    <input type="hidden" name="messageFileId" id="messageFileId" value=""/>
                    <input type="hidden" name="messageFileName" id="messageFileName"  value=""/>
                 <%--<input type="file" class="file" id="file_id" name="file"/> --%>
                </a>
            </div>
            ...
            <div class="boxsm">
                ...
                <div class="messages">
                    ...
                    <table class="table">
                        <thead>
                        <tr>
                            <td style="text-align: center;"><input type="checkbox" class="check_box" name="allChecked"
                                                                   id="allChecked" onclick="DoCheck()" value="0"/></td>
                            <td>书序</td>
                            <td>书籍名称</td>
                            <td>版次</td>
                        </tr>
