...
<script type="text/javascript">
 ...
 <form class="message-list"  id="theForm" action="${pageContext.request.contextPath}/authSendMessage/sendMessage.action" method="post" onsubmit="return getValue();"   enctype="multipart/form-data" >
        <div class="title">
            <span  class="span1" style="margin-right: 25px;"><span class="span2">*</span>标题</span>
            <input type="text" name="titleValue" id="TitleValue" placeholder="请输入消息标题 30字以内"  oninput="if(value.length>30){value=value.slice(0,30)}"/>
        ...
        <div class="appendix" >
             ...
             <div style="display: inline;">
                    <span class="icon"> </span> <span class="name" id="file_name"></span> <a href="javascript:void(0);" class="operate input">
