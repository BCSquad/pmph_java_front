    ...
    <form class="message-list" id="theForm"
        ...
        <div class="message-input">
          ...
          <!--   <script type="text/plian" id="mText"
           ...
           <div style="width: 1060px; height:600px;position:absolute;left:126px;top:0px">  <textarea rows="8" cols="50" placeholder="请输入内容" id="UEContent" name ="UEContent" required></textarea></div>
        </div>
       <!--  <div class="appendix">
                         <span class="span1">
