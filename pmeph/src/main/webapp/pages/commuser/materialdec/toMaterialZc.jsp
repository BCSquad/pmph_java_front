    ...
    <div class="content-wrapper">
        ...
        <div class="sbxq_title">
            <span><a style="text-decoration: none;color: #999999;"
                    ...
                    href="${contextpath}/personalhomepage/tohomepage.action?pagetag=jcsb&pageNum=1&pageSize=10"> 教材申报 </a> > 修改申报表</span>
        </div>
        <!-- 图书选择-->
        <form id="objForm">
            <div class="sbxq_item1" id="tsxz">
                <div>
                    ...
                    <input type="hidden" id="declaration_id" name="declaration_id"
                           value="${materialMap.declaration_id}"/>
                    <input type="hidden" id="online_progress" name="online_progress"
                           value="${gezlList.online_progress}"/>
                    <!-- 是否编委 -->
                    <input type="hidden" id="sfbw" name="sfbw" value="${materialMap.is_digital_editor_optional}"/>
                    <!-- 是否书籍多选 -->
                    <input type="hidden" id="is_multi_books" name="is_multi_books"
                           value="${materialMap.is_multi_books}"/>
                    <!-- 是否职位多选 -->
                    <input type="hidden" id="is_multi_position" name="is_multi_position"
                           value="${materialMap.is_multi_position}"/>
                                ...
                                <tr>
                                    ...
                                    <c:if test="${materialMap.is_multi_position !='1'}">
                                        ...
                                        <td><input type="radio" name="zw_1_${status.count}"
                                                   value="2" ${list.preset_position=='2'?'checked':'' }/>副主编
                                        </td>
                                        <td><input type="radio" name="zw_1_${status.count}"
                    ...
                    <table class="tab_1">
                        ...
                        <tr>
                            <td><span>&ensp;服从调剂：</span>
                                <input type="radio" name="is_dispensed"
                                       value="1" ${gezlList.is_dispensed=='1'?'checked':'' }/>是
                                <input type="radio" name="is_dispensed"
                                       value="0" ${gezlList.is_dispensed=='0'?'checked':'' }/>否
                            </td>
                    ...
                    <table class="tab_2" id="tab_jxjz">
                        ...
                        <c:if test="${empty steaList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_jxjl()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${steaList}" varStatus="status">
                            <tr id="jxjz_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="jx_note" value="${list.note}"
                                           style="width: 180px;" placeholder="备注"/>
                                    <input type="hidden" name="jx_id" value="${list.per_id}">
                                ...
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_jxjl()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('jxjz_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_jccb">
                        ...
                        <c:if test="${empty jcbjList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_jccb()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${jcbjList}" varStatus="status">
                            <tr id="jccb_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="jc_note" value="${list.note}"
                                    ...
                                    <input type="hidden" name="jc_id" value="${list.per_id}">
                                </td>
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_jccb()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('jccb_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_gjghjc">
                        ...
                        <c:if test="${empty gjghjcList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_gjghjc()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${gjghjcList}" varStatus="status">
                            <tr id="gjghjc_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="hj_note" value="${list.note}"
                                    ...
                                    <input type="hidden" name="hj_id" value="${list.per_id}">
                                        <%--
        ...
        --%>
                                ...
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_gjghjc()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('gjghjc_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_qtjcbxqk">
                        ...
                        <c:if test="${empty jcbxqtList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_jcbx()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${jcbxqtList}" varStatus="status">
                            <tr id="jcbx_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="jcb_note" value="${list.note}"
                                    ...
                                    <input type="hidden" name="jcb_id" value="${list.per_id}">
                                        <%--
                                ...
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_jcbx()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('jcbx_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_jpkcjs">
                        ...
                        <c:if test="${empty gjkcjsList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_jpkcjs('tab_jpkcjs',1)"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${gjkcjsList}" varStatus="status">
                            <tr id="jpkcjs_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="gj_note" value="${list.note}"
                                    ...
                                    <input type="hidden" name="gj_id" value="${list.per_id}">
                                        <%--  <input type="hidden" name="zdjy" value="gj_course_name_${status.count},gj_class_hour_${status.count}"/>--%>
                                </td>
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_jpkcjs('tab_jpkcjs',1)"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('jpkcjs_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                        ...
                        <c:forEach var="list" items="${zjkyList}" varStatus="status">
                            <tr id="zjky_${status.count}">
                                ...
                                <td><input class="cg_input" maxlength="100" name="zjk_note" value="${list.note}"
                                    ...
                                    <input type="hidden" name="zjk_id" value="${list.per_id}">
                                        <%--
                                ...
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_zjky()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('zjky_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_publish">
                        ...
                        <c:if test="${empty publishList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_publish()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${publishList}" varStatus="status">
                            <tr id="publish_${status.count}">
                                ...
                                <td><input class="cg_input" name="pu_note" value="${list.note}" style="width: 250px;"
                                    ...
                                    <input type="hidden" name="pu_id" value="${list.per_id}">
                                        <%--<input type="hidden" name="zdjy" value="pu_reward_name_${status.count},pu_award_unit_${status.count},pu_reward_date_${status.count}"/>--%>
                                </td>
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_publish()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('publish_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                        ...
                        <c:forEach var="list" items="${sciList}" varStatus="status">
                            <tr id="sci_${status.count}">
                                ...
                                <td><input class="cg_input" name="sci_note" value="${list.note}" style="width: 140px;"
                                    ...
                                    <input type="hidden" name="sci_id" value="${list.per_id}">
                                ...
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_sci()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('sci_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_clinical">
                        ...
                        <c:if test="${empty clinicalList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_clinical()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${clinicalList}" varStatus="status">
                            <tr id="clinical_${status.count}">
                                ...
                                <td><input class="cg_input" name="cl_note" value="${list.note}" style="width: 230px;"
                                    ...
                                    <input type="hidden" name="cl_id" value="${list.per_id}">
                                        <%--   <input type="hidden" name="zdjy" value="cl_reward_name_${status.count},cl_reward_date_${status.count}"/>--%>
                                </td>
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_clinical()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('clinical_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
                    ...
                    <table class="tab_2" id="tab_acade">
                        ...
                        <c:if test="${empty acadeList[0]}">
                            <tr>
                                ...
                                <td><img class="add_img" src="${ctx}/statics/image/add.png"
                                         onclick="javascript:add_acade()"/></td>
                            </tr>
                        </c:if>
                        <c:forEach var="list" items="${acadeList}" varStatus="status">
                            <tr id="acade_${status.count}">
                                ...
                                <td><input class="cg_input" name="ac_note" value="${list.note }" style="width: 180px;"
                                    ...
                                    <input type="hidden" name="ac_id" value="${list.per_id}">
                                        <%-- <input type="hidden" name="zdjy" value="ac_reward_name_${status.count},ac_reward_date_${status.count}"/>--%>
                                </td>
                                <td><c:choose>
                                    <c:when test="${status.count == 1}">
                                        <img class="add_img" src="${ctx}/statics/image/add.png"
                                             onclick="javascript:add_acade()"/>
                                    </c:when>
                                    <c:otherwise>
                                        <img class="add_img" src="${ctx}/statics/image/del.png"
                                             onclick="javascript:del_tr('acade_${status.count}')"/>
                                    </c:otherwise>
                                </c:choose></td>
                            </tr>
                        </c:forEach>
            ...
            <div class="sbxq_item1">
                ...
                <div class="sbdw">
                    ...
                    <input class="cg_input" id="sbdw_name" name="sbdw_name" value="${gezlList.dwmc}"
                           style="width: 300px;" onclick="javascript:orgAdd('${materialMap.material_id}')"
                           readonly="readonly"/>
