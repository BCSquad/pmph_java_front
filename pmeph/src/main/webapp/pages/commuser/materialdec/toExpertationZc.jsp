                        ...
                        <tr>
                            ...
                            <td><span class="btbs">*</span><span>学&emsp;&emsp;历：</span>
                                <select id="education" name="education">
                                    ...
                                    <option value="3" ${gezlList.education=='3'?'selected':'' }>博士</option>
                                    <option value="4" ${gezlList.education=='4'?'selected':'' }>博士后</option>
                                </select></td>
                        </tr>
                        <tr>
                    ...
                    <table class="tab_2" id="tab_wzfbqk">
                        ...
                        <c:forEach var="list" items="${wzfbqkList}" varStatus="status">
                            <tr id="wzfbxq_${status.count}">
                                ...
                                <td class="xztd"><input class="cg_input xzip" name="wzfb_qkmc" value="${list.periodical_title}" placeholder="期刊名称" maxlength="50"/></td>
                                <td class="xztd"><input class="cg_input xzip" name="wzfb_njq"  value="${list.year_volume_period}" placeholder="年、卷、期" maxlength="50"/></td>
                                <td class="xztd"><input class="cg_input xzip" maxlength="50" name="wzfb_qklb" value="${list.periodical_level}"  placeholder="期刊级别（SCI或国内核心期刊）"/></td>
