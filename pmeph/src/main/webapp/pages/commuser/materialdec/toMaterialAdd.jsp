	...
	<div class="content-wrapper">
					...
					<tr>
						...
						<td><span class="btbs">*</span><span>职&emsp;&emsp;称：</span>
                            <select class="select-input" id="zc" name="title">
                                ...
                                <option value="1">叫兽</option>
                                <option value="3">交手</option>
                            </select></td>
			...
			<div class="content">
				<table class="tab_2" id="tab_xxjl">
					...
					<tbody>
						<tr>
							<td>
								<input class="cg_input" placeholder="开始时间" calendar format="'yyyy-mm-dd'" offset="[-86,9]" z-index="100"  name="xx_kssj" value="" style="width: 80px;"/>
								-
								<input class="cg_input" placeholder="结束时间" calendar format="'yyyy-mm-dd'" offset="[-34,9]" z-index="100" name="xx_jssj" value="" style="width: 80px;"/>
							</td>
			...
			<div class="content">
				<table class="tab_2" id="tab_gzjl">
					...
					<tbody>
						<tr>
							<td>
								<input class="cg_input" placeholder="开始时间" calendar format="'yyyy-mm-dd'" offset="[-84,9]" z-index="100"  name="gz_kssj" value="" style="width: 80px;"/>
								-
								<input class="cg_input" placeholder="结束时间" calendar format="'yyyy-mm-dd'" offset="[-34,9]" z-index="100" name="gz_jssj" value="" style="width: 80px;"/>
							</td>
			...
			<div class="content">
				<table class="tab_2" id="tab_jxjz">
					...
					<tbody>
						<tr>
							<td>
								<input class="cg_input" placeholder="开始时间" calendar format="'yyyy-mm-dd'" offset="[-84,9]" z-index="100"  name="jx_kssj" value="" style="width: 80px;"/>
								-
								<input class="cg_input" placeholder="结束时间" calendar format="'yyyy-mm-dd'" offset="[-34,9]" z-index="100" name="jx_jssj" value="" style="width: 80px;"/>
							</td>
							<td><input class="cg_input" name="school_name" value="" /></td>
					...
					<tbody>
						<tr>
							...
							<td style="color: #333333;">
								<input type="radio" name="rank_xs" value="1" checked="checked"/>国际
								<input type="radio" name="rank_xs" value="2" />国家
								<input type="radio" name="rank_xs" value="3" />省部
								<input type="radio" name="rank_xs" value="4" />其他
							</td>
		...
		<div class="sbxq_item">
			<div>
				...
				<span class="tsxz_title">精品课程建设情况（选填）</span>
			</div>
			<div class="content">
				<table class="tab_2" id="tab_jpkcjs">
					...
					<tbody>
						<tr>
							...
							<td style="color: #333333;">
								<input type="radio" name="rank_jp" value="1" checked="checked" />国家
								<input type="radio" name="rank_jp" value="2" />省部
								<input type="radio" name="rank_jp" value="3" />学校
							</td>
							<td><input class="cg_input" name="jp_note" value="" style="width: 250px;"/></td>
							<td><img class="add_img" src="${ctx}/statics/image/add.png" onclick="javascript:add_jpkcjs()"/></td>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table class="tab_2" id="tab_gjghjc">
					...
					<tbody>
						<tr>
							...
							<td><input class="cg_input" name="class_hour" value="" style="width: 110px;"/></td>
							<td style="color: #333333;">
								<input type="radio" name="rank" value="1" checked="checked" />教育部十二五
								<input type="radio" name="rank" value="2" />国家卫计委十二五
								<input type="radio" name="rank" value="3" />其他
							</td>
							<td><input class="cg_input" name="note" value="" style="width: 250px;"/></td>
		...
		<div class="sbxq_item">
			...
			<div class="content">
				<table class="tab_2">
					...
					<tbody>
						<tr>
							<td><input class="cg_input" name="class_hour" value="" style="width: 210px;"/></td>
							<td>
								<select id="jcxz" name="jcxz">
							...
							<td><input class="cg_input" name="class_hour" value="" style="width: 120px;"/></td>
							<td><input class="cg_input" placeholder="出版时间" calendar format="'yyyy-mm-dd'" offset="[-34,9]" z-index="100" name="jx_jssj" value="" style="width: 110px;"/></td>
							<td><input class="cg_input" name="class_hour" value="" style="width: 110px;"/></td>
							<td><input class="cg_input" name="class_hour" value=""/></td>
							<td><img class="add_img" src="${ctx}/statics/image/add.png"/></td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<div class="sbxq_item">
			...
			<div class="content">
				<table class="tab_2">
					...
					<tbody>
						<tr>
							<td><input class="cg_input" name="material_name" value="" style="width: 200px;"/></td>
							<td><input class="cg_input" name="material_name" value="" style="width: 200px;"/></td>
							<td><input class="cg_input" name="jc_note" value="" style="width: 300px;"/></td>
							<td><input class="cg_input" name="jc_note" value="" style="width: 300px;"/></td>
							<td><img class="add_img" src="${ctx}/statics/image/add.png"/></td>
						</tr>
					</tbody>
