				...
				<div class="content">
					<table class="tab_1">
						<tr>
							...
							<td><span>出生年月：</span>
								<input class="cg_input" calendar format="'yyyy-mm-dd'" name="birthday" validator= "isNonEmpty"  message= "出生日期不能为空"
									   value="${userMap.birthday}" id="birthday"/></td>
						...
						<tr>
							...
							<td><span>职&emsp;&emsp;务：</span>
								<input class="cg_input" name="position" value="${userMap.position}" id="position"
									   validator="isNonEmpty"
									   message="职务不能为空"
									   maxlength="36"/></td>
