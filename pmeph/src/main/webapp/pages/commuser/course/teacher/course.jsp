        ...
        <div class="list" style="background-color: white" >
            ...
            <div class="dialog" id="course-dialog">
                ...
                <div class="info">
                    ...
                    <div class="table-area" style="max-height: 500px;overflow-y: scroll;">
                        <table >
                            <tr>
                    ...
                    <div class="btn-wrapper">
                        <button class="btn" id="btn-confirm" onclick="teacherAddBook()">确定</button>
                        <button class="btn" id="btn-cancle" onclick="$('#course-dialog').fadeOut(500);">取消</button>
                    </div>
