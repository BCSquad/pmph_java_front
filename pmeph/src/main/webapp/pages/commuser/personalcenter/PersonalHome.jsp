...
<c:forEach items="${listmyofeernew}" begin='0' end='1' var="listmon" varStatus="status">
                    <div class="xiaoxi">
                        <div class="dtshang">
                            <c:if test="${listmon.online_progress==3}"><div class="shangleft">通过了审核</div></c:if>
                            <c:if test="${listmon.online_progress==2}"><div class="shangleft">退回了选题</div></c:if>
                            <div class="shangright">${listmon.gmt_update}</div>
                        </div>
                        <div class="dtzhong">
                            <c:if test="${listmon.online_progress==3}"><span id="xinxiaoxi">	</span> <span class="rlan">恭喜！您于${listmon.gmt_create}申报的《${listmon.material_name}》编委审核已通过。</span>
                            <span id="xiaoxitongguo"></span></c:if>
                            <c:if test="${listmon.online_progress==2}"><span id="xinxiaoxi">	</span> <span class="rlan">非常抱歉！您于${listmon.gmt_create} 提交的《${listmon.material_name}》选题被退回，请您尽快检查修改！</span>
                    ...
                    <div class="shenbaoliebiao">
                        <ul class="scul">
                            ...
                            <li class="leftlb">
                                ...
                                <c:if test="${list.iamin==0}"><div class="mleft">
                                    <div class="ysbrs">
                                        <div class="baomingrenshu"><span class="canjiarenshu">${list.exmember}</span><span>人</span>
...
<c:if test="${list.iamin==1&&list.online_progress==1}"><div class="mleft1">
                                    <div class="ysbrs1">
                                        <div class="baomingrenshu1"><span class="canjiarenshu1">${list.exmember}</span><span>人</span>
...
<c:if test="${list.iamin==1&&list.online_progress==2}"><div class="mleft2">
                                    <div class="ysbrs2">
                                        <div class="baomingrenshu2"><span class="canjiarenshu2">${list.exmember}</span><span>人</span>
                    ...
                    <!--<div class="shenbaoliebiao">
                        <ul class="scul">-->
                            <li class="leftlb">
                                ...
                                <div class="mright">
                                    <div class="rshang">
                                        <div class="rshangn">全国高等学校五年制临床医学专业第九轮规划材料<img src="${ctx}/statics/image/zancun.png"></div>
                                    </div>
                                    <div class="rxia">
...
<c:forEach items="${listmywritingsnew}" begin='0' end='5' var="listmon" varStatus="status">
            ...
            <div class="right">
                ...
                <div id="wdxz"><span id="xztb"></span><span class="rlan">我加入的小组</span><span
                    ...
                    <br/>
                    <ul class="scul">
                    <c:forEach items="${listmygroup}" begin='0' end='8' var="listmyg" varStatus="status"><li class="wdxz"><img src="${ctx}${listmyg.group_image}" class="xztp"><br/>${listmyg.group_name}<br/><span class="xzrs">(${listmyg.grouppeo}人)</span></li></c:forEach>
                    </ul>
                </div>
                <div id="bzzx">
                    <div id="bzxxherd"></div>
