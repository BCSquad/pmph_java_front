...
<script type="text/javascript">
    ...
    <script src="${ctx}/resources/commuser/personalcenter/PersonalHomeOneMy.js?t=${_timestamp}"></script>
            ...
            <div class="left">
                ...
                <div id="jiaocaishenbao">
                    <div class="jcsbssl"><input type="hidden" id="pageinfo" value="${permap.pageinfo}">
                        <span id="jcsbqbmy"  onclick="listoction();" style="cursor:pointer">全部</span><span id="jcsbwdsbmy" style="cursor:pointer">我的申报</span><span class="jcsbsbzt"  onclick="listoction1();" id="sbzzjx" style="cursor:pointer">正在进行</span><span
                            class="jcsbsbzt" id="sbyjs" onclick="listoction2();" style="cursor:pointer">已结束</span>
