        ...
        <div class="content">
            <div class="left">
                ...
                <div id="jiaocaishenbao">
                    <div class="jcsbssl">
                        <span id="jcsbqbmy"  onclick="listoction();" style="cursor:pointer">全部</span><span id="jcsbwdsbmy" style="cursor:pointer">我的申报</span><span class="jcsbsbzt"  onclick="listoction1();" style="cursor:pointer">正在进行</span><span
                            class="jcsbsbzt"  onclick="listoction2();" style="cursor:pointer">已结束</span>
