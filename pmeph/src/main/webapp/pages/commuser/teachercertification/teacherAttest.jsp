...
<head>
    ...
    <link href="<%=path%>/statics/home/read.css" rel="stylesheet" type="text/css" />
     <link href="<%=path%>/statics/authadmin/accountset/publicStyle.css" rel="stylesheet" type="text/css"/>
            ...
            $('#certForm').validate({
                ...
                type:{
                	...
                	isSelected:function(value, errorMsg, el){
                		var i = 0;    
                		var $collection = $("#Select1").find("li[class='selected']");    
...
<body>
    ...
    <div class="sxy-div-content">
        ...
        <div><font id="sxy-td-title">学校教师认证说明</font></div>
        <div id="sxy-divtop">
         ...
         <img class="cupline" alt="" src="<%=path%>/statics/image/_cupline.jpg"/>
               
         <form id="certForm" action="${pageContext.request.contextPath}/teacherCertification/updateTeacherCertification.action" method="post">
