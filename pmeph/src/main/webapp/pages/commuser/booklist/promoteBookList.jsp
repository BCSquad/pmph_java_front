...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<%=path%>/statics/commuser/booklist/bookList.css?t=${_timestamp}" type="text/css">
    ...
    <script src="<%=path%>/resources/commuser/booklist/booklist.js?t=${_timestamp}"></script>
  </head>
...
<script type="text/javascript">
    ...
    function pageFun(pageSize,pageNumber,order,materialType){
    	window.location.href = '<%=path%>/books/promoteList.action?pageSize='+pageSize+'&pageNumber='+pageNumber+'&order='+order+'&type='+materialType;
    }
</script>
