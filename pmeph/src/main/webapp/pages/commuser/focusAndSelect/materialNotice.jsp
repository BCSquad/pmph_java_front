...
<link rel="stylesheet" href="${ctx}/statics/css/base.css"
	type="text/css">
<link rel="stylesheet"
	href="${ctx}/statics/commuser/focusAndSelect/newsReportAndMaterialNotice.css"
	type="text/css">
		...
		<div class="div_content">
			<div class="div_content_left">
				<span class="clickbefore mouse-gesture" id="infoReport"
					onclick="ChangeDiv('infoReport')">信息快报</span> <span class="clicked"
					style="margin-left: 15px;" id="selectAnnco"
					onclick="ChangeDiv('selectAnnco')">遴选公告</span>
			</div>
			<div class="div_content_right">
				<span style="color: #999999;">排序：</span>
				<div
					style="display: inline-block; text-align: left; color: #333333;">
			...
			<div class="left">
				...
				<div class="no-more" style="display: none" id="nomore">
					<img src="<c:url value="/statics/image/aaa4.png"></c:url>"
						style="display: block; margin: 0px auto 0px;"> <span
						style="display: block; width: 100px; margin: 0px auto 0px;">木有内容呀~~</span>
				</div>
			</div>
			<div class="right" style="width: 335px; float: right;">
				<img src="${ctx}/statics/image/caode.png"
					style="width: 335px; height: 335px;" />
			</div>
		</div>
	</div>
	<div
		style="width: 100%; clear: both; padding: 0; margin: 0; height: 160px; border: none">
