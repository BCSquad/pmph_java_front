...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/statics/commuser/focusAndSelect/newsReportAndMaterialNotice.css?t=${_timestamp}"
          type="text/css">
...
<div class="content-body">
    ...
    <div style="margin-top:25px;">
        ...
        <div class="right" style="width: 335px;float: right;">
            ...
            <img src="${ctx}/image/${fn:length(adInfo.detailList)>0?adInfo.detailList[0].image:'caode.png'}.action"
