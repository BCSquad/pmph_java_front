...
<head>
    ...
    <link rel="stylesheet" href="<%=path%>/statics/commuser/homepage/hotbookcomments.css?t=${_timestamp}" type="text/css">
    ...
    <script src="<%=path%>/resources/commuser/homepage/hotbookcomments.js?t=${_timestamp}"></script>
