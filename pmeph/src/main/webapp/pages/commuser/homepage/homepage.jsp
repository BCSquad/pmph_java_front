                ...
                <c:forEach items="${listDou}" var="list" varStatus="status">
                    <c:if test="${status.index==0}">
                        <div class="content-left" style="margin-left: 30px">
                            <p class="content-size"><a href="${ctx}/message/noticeMessageDetail.action?id=${list.id }"
                ...
                <div class="content">
                    <div class="left">
                        <div class="left_one">
                            ...
                            <c:forEach items="${listDou}" var="list" varStatus="status">
                                <c:if test="${status.index==0}">
                                    <div class="left_con1" style="margin-top: 63px;"
                                         onclick="todou('${list.mid}')">${list.title}</div>
                                </c:if>
                                <c:if test="${status.index!=0}">
            ...
            <div class="area-7">
                ...
                <div class="item">
                    ...
                    <c:forEach items="${listAut}" var="list" varStatus="status">
                        <c:if test="${status.index==0}">
                            <div class="author1">
                                <div class="a7_head_div"><img src="${ctx}/statics/testfile/a6_photo.png"
                                                              class="a6_head">
                                </div>
