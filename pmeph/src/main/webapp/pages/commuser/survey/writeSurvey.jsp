...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/statics/commuser/survey/writeSurvey.css?t=${_timestamp}" type="text/css">
    <script src="${ctx}/resources/comm/jquery/jquery.js?t=${_timestamp}"></script>
    <script src="${ctx}/resources/comm/base.js?t=${_timestamp}"></script>
    <script src="${ctx}/resources/comm/layer/layer.js?t=${_timestamp}"></script>
    <script src="${ctx}/resources/commuser/survey/writeSurvey.js?t=${_timestamp}"></script>
