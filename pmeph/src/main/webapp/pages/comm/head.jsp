        ...
        <div class="content">
            ...
            <c:if test="${userInfo == null}">
                <div class="login-logout">
                    <a onclick="window.location.href='${redirectUrl}?ServiceID=${serviceID}&Referer='+encodeURIComponent(window.location.href)" href='javascript:;'>登录</a>
                    <span>/</span>
                    <a onclick="window.location.href='${redirectUrl}?ServiceID=${serviceID}&Referer='+encodeURIComponent(window.location.href)" href='javascript:;'>注册</a>
