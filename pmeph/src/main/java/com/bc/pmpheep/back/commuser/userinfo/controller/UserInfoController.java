...
//		id="12179";
	...
	public Map<String, Object> update(HttpServletRequest request){
		...
		if(StringUtils.isEmpty(id)||
			...
			map.put("id", id);map.put("realname", realName);map.put("experience", experience);
			map.put("fax", fax);map.put("sex", sex);map.put("title", title);map.put("handphone", handphone);
			map.put("postcode", postCode);map.put("birthday", birthday);map.put("email", email);
			map.put("org_id", org_id);map.put("position", position);map.put("address", address);
			map.put("note", note);map.put("workplace", workplace);
