...
public class InfoReleaseServiceImpl implements InfoReleaseService {
	...
	@Override
	public List<Map<String, Object>> selectInfoRelease(PageParameter<Map<String, Object>> pageParameter) {
		...
		List<Map<String,Object>> resultList = infoReleaseDao.selectInfoRelease(paraMap);
		return resultList;
	}

	@Override
	public int selectInfoReleaseCount(PageParameter<Map<String, Object>> pageParameter) {
