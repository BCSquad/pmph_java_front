...
public interface PersonInfoDao {
		...
		public int updatePerStu(Map<String, Object> map);
		...
		public int updatePerWork(Map<String, Object> map);
		...
		public int updatePerStea(Map<String, Object> map);
		...
		public int updatePerZjxs(Map<String, Object> map);
		...
		public int updatePerJcbj(Map<String, Object> map);
		...
		public int updatePerGjkcjs(Map<String, Object> map);
		...
		public int updatePerGjghjc(Map<String, Object> map);
		...
		public int updatePerJcbx(Map<String, Object> map);
		...
		public int updatePerRwsjc(Map<String, Object> map);
		...
		public int updatePerZjkyqk(Map<String, Object> map);
		...
		public int updatePerMonograph(Map<String, Object> map);
		...
		public int updatePerPublish(Map<String, Object> map);
		...
		public int updatePerSci(Map<String, Object> map);
		...
		public int updatePerClinicalreward(Map<String, Object> map);
