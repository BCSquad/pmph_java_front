...
public interface PersonalDao {
	...
	public List<Map<String, Object>> ListMyBookNewsTwo(
			PageParameter<Map<String, Object>> pageParameter);

	public List<Map<String, Object>> ListAllBookJoin(
			PageParameter<Map<String, Object>> pageParameter);

	public Integer queryMyBooksJoinCount(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public Integer queryMyTopicChooseCount(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public List<Map<String, Object>> ListMyWritingsTwo(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public Integer queryMyWritingsNewCount(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public Integer queryBookCorrectdCount(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public Integer queryMyCorrectionCount(
			PageParameter<Map<String, Object>> pageParameter);
	 ...
	 * @return
	 */
	public Integer queryWriterUserTrendstCount(
			PageParameter<Map<String, Object>> pageParameter);
