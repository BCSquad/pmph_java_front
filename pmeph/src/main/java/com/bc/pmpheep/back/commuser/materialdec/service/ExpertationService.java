...
public interface ExpertationService {
	...
	public Map<String,Object> insertJcsbxx(Map<String, Object> perMap, List<Map<String, Object>> stuList, List<Map<String, Object>> workList,
				   ...
				   List<Map<String, Object>> pmphList,List<Map<String,Object>> subjectList,List<Map<String,Object>> contentList,List<Map<String,Object>> sbzyList,List<Map<String,Object>> editorList,
	...
	public Map<String,Object> updateJcsbxx(Map<String, Object> perMap, List<Map<String, Object>> stuList, List<Map<String, Object>> workList,
				   List<Map<String, Object>> zjxsList, List<Map<String, Object>> zjkzqkList,List<Map<String, Object>> monographList,
				   List<Map<String, Object>> pmphList,List<Map<String,Object>> subjectList,List<Map<String,Object>> contentList,List<Map<String,Object>> sbzyList,List<Map<String,Object>> editorList, List<Map<String, Object>> wzfbqkList,
	 ...
	 * 申报专业
	 */
	PageResult<Map<String, Object>> querySbzyList(PageParameter<Map<String, Object>> pageParameter);
